  ...
  
{
  ...
  },
  {
    ...
    material: "sterling_silver",
    images: ["./assets/images/product-34-01.png"],
    featured: false,
    categories: ["Znaki zodiaku"],
    description:
      "Bransoletka z naturalnego akwamarynu w delikatnych odcieniach błękitu i jasnego beżu, ozdobiona srebrną zawieszką z symbolem inspirowanym znakami zodiaku. Subtelna, lekka kompozycja nawiązująca do harmonii natury i energii kosmicznych. Akwamaryn kojarzony jest ze spokojem, równowagą i klarownością myśli. Idealna dla osób ceniących symbolikę i indywidualny charakter biżuterii.",
    specs: {
      kamienie: "Akwamaryn",
      metal: "Srebro 925",
      waga: "0,34 g",
    ...
    gallery: [
      "./assets/images/product-34-01.png",
      "./assets/images/product-34-02.png",
      "./assets/images/product-34-03.png",
    ],
  },
  {
    id: "mokait-grawer",
    name: "Bransoletka — Mokait (grawer)",
    price: 180,
    currency: "PLN",
    colors: ["red", "brown", "beige", "yellow", "silver"],
    material: "sterling_silver",
    images: ["./assets/images/product-33-01.png"],
    featured: false,
    categories: ["Personalizacja (Grawer)"],
    description:
      "Bransoletka z naturalnego mokaitu w ciepłych, ziemistych odcieniach czerwieni, brązu, beżu i żółci, uzupełniona srebrną zawieszką. Wyrazista, energetyczna kompozycja inspirowana naturą i kolorami ziemi. Mokait kojarzony jest z odwagą, równowagą i podejmowaniem decyzji. Idealna jako unikalny dodatek lub wyjątkowy prezent. Możliwość personalizacji — wykonania graweru z imieniem, inicjałami, datą lub symbolem.",
    specs: {
      kamienie: "Mokait",
      metal: "Srebro 925",
      waga: "1,56 g",
    ...
    gallery: [
      "./assets/images/product-33-01.png",
      "./assets/images/product-33-02.png",
      "./assets/images/product-33-03.png",
    ],
  },
  {
    id: "morganit-koniczyna",
    name: "Bransoletka — Morganit (koniczyna)",
    price: 195,
    currency: "PLN",
    colors: ["blue", "green", "pink", "silver"],
    material: "sterling_silver",
    images: ["./assets/images/product-32-01.png"],
    featured: false,
    categories: ["Natura"],
    description:
      "Bransoletka z naturalnego morganitu w delikatnych pastelowych odcieniach błękitu, zieleni i różu, ozdobiona srebrną zawieszką w kształcie koniczyny. Subtelna i romantyczna kompozycja inspirowana naturą oraz uczuciami. Morganit kojarzony jest z miłością, harmonią i spokojem, dlatego idealnie sprawdzi się jako symbol bliskości. Doskonała na prezent dla bliskiej osoby.",
    specs: {
      kamienie: "Morganit",
      metal: "Srebro 925",
      waga: "0,34 g",
    ...
    gallery: [
      "./assets/images/product-32-01.png",
      "./assets/images/product-32-02.png",
      "./assets/images/product-32-03.png",
    ],
  },
  {
    id: "kalcyt-rozgwiazda",
    name: "Bransoletka — Kalcyt (rozgwiazda)",
    price: 145,
    currency: "PLN",
    colors: ["yellow", "white", "silver"],
    material: "sterling_silver",
    images: ["./assets/images/product-31-01.png"],
    featured: false,
    categories: ["Natura"],
    description:
      "Bransoletka z naturalnego kalcytu w ciepłych, słonecznych odcieniach żółci i kremu, ozdobiona srebrną zawieszką w kształcie rozgwiazdy. Lekka i świeża kompozycja inspirowana naturą oraz nadmorskim klimatem. Kalcyt kojarzony jest z pozytywną energią, motywacją i wewnętrzną harmonią. Idealna jako delikatny dodatek na co dzień lub letni akcent stylizacji.",
    specs: {
      kamienie: "Kalcyt",
      metal: "Srebro 925",
      waga: "0,47 g",
    ...
    gallery: [
      "./assets/images/product-31-01.png",
      "./assets/images/product-31-02.png",
      "./assets/images/product-31-03.png",
    ],
  },
  {
    id: "jaspis-szary-rozowy-kwarc",
    name: "Bransoletka — jaspis szary i różowy kwarc",
    price: 235,
    currency: "PLN",
    colors: ["gray", "pink", "silver"],
    material: "sterling_silver",
    images: ["./assets/images/product-30-01.png"],
    featured: false,
    categories: ["Kolekcja"],
    description:
      "Bransoletka z naturalnego jaspisu szarego i różowego kwarcu, uzupełniona srebrnymi elementami. Stonowana, elegancka kompozycja w odcieniach szarości i bieli, idealna dla osób ceniących minimalizm i ponadczasowy styl. Jaspis wspiera równowagę i stabilność, a kwarc kojarzony jest z harmonią i oczyszczeniem. Doskonała jako uniwersalny dodatek na co dzień lub prezent.",
    specs: {
      kamienie: "Jaspis szary, różowy kwarc",
      metal: "Srebro 925",
      waga: "2,9 g",
    },
    gallery: [
      "./assets/images/product-30-01.png",
      "./assets/images/product-30-02.png",
      "./assets/images/product-30-03.png",
    ],
  },
  {
